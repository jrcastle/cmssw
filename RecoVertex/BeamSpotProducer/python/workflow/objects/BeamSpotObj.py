    ...
    def Dump(self, file, mode = 'a'):
        ...
        towrite = 'Runnumber {RUN}\n'                           \
                  ...
                  ''.format(RUN       = str(self.Run          ),
                            ...
                            # diagonal
                            M00       = str(self.Xerr          * self.Xerr         ),
                            M11       = str(self.Yerr          * self.Yerr         ),
                            M22       = str(self.Zerr          * self.Zerr         ),
                            M33       = str(self.sigmaZerr     * self.sigmaZerr    ),
                            M44       = str(self.dxdzerr       * self.dxdzerr      ),
                            M55       = str(self.dydzerr       * self.dydzerr      ),
                            M66       = str(self.beamWidthXerr * self.beamWidthXerr),
                            # off diagonal
                            M01       = str(self.XYerr        ),
                            M10       = str(self.YXerr        ),
